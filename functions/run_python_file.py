...
schema_run_python_file = types.FunctionDeclaration(
    ...
    description="Run the python file located at the specified file path, constrained to the working directory.",
    parameters=types.Schema(
        ...
        properties={
            ...
            "args": types.Schema(
                type=types.Type.STRING,
                description="Optional arguments that can be included in our run command. None by default.",
            ),
        },
    ),
)
